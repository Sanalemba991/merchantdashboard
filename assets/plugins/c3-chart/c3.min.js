...
!(function (t, e) {
      ...
      function T(t, m) {
        ...
        return (
          t.each(function () {
            ...
            var f,
              _,
              x = n.selectAll(".domain").data([0]),
              y = x.enter().append("path").merge(x).attr("class", "domain");
            switch (w.orient) {
              case "bottom":
                (t = w.axisX),
                  u
  ...
  (y.prototype.init = function () {
    ...
    (y.prototype.getXAxis = function (t, e, i, n, r, a, o) {
      var s = this.owner,
        c = s.config,
        d = {
    ...
    (y.prototype.updateXAxisTickValues = function (t, e) {
      var i,
        n = this.owner,
        r = n.config;
      return (
    ...
    (y.prototype.getYAxis = function (t, e, i, n, r, a, o) {
      var s = this.owner,
        c = s.config,
    ...
    (y.prototype.getId = function (t) {
      var e = this.owner.config;
      return t in e.data_axes ? e.data_axes[t] : "y";
    }),
    (y.prototype.getXAxisTickFormat = function () {
      var e = this.owner,
        i = e.config,
        n = e.isTimeSeries()
    ...
    (y.prototype.getTickValues = function (t, e) {
      return t || (e ? e.tickValues() : void 0);
    }),
    (y.prototype.getXAxisTickValues = function () {
      return this.getTickValues(
        this.owner.config.axis_x_tick_values,
        this.owner.xAxis
      );
    }),
    (y.prototype.getYAxisTickValues = function () {
      return this.getTickValues(
        this.owner.config.axis_y_tick_values,
        this.owner.yAxis
      );
    }),
    (y.prototype.getY2AxisTickValues = function () {
      return this.getTickValues(
        this.owner.config.axis_y2_tick_values,
        this.owner.y2Axis
      );
    }),
    (y.prototype.getLabelOptionByAxisId = function (t) {
      var e,
        i = this.owner.config;
      return (
        "y" === t
    ...
    (y.prototype.getLabelText = function (t) {
      var e = this.getLabelOptionByAxisId(t);
      return x(e) ? e : e ? e.text : null;
    }),
    (y.prototype.setLabelText = function (t, e) {
    ...
    (y.prototype.getLabelPosition = function (t, e) {
    ...
    (y.prototype.getXAxisLabelPosition = function () {
      return this.getLabelPosition(
        "x",
        this.owner.config.axis_rotated ? "inner-top" : "inner-right"
      );
    }),
    (y.prototype.getYAxisLabelPosition = function () {
      return this.getLabelPosition(
        "y",
        this.owner.config.axis_rotated ? "inner-right" : "inner-top"
      );
    }),
    (y.prototype.getY2AxisLabelPosition = function () {
      return this.getLabelPosition(
        "y2",
        this.owner.config.axis_rotated ? "inner-right" : "inner-top"
      );
    }),
    (y.prototype.getLabelPositionById = function (t) {
      return "y2" === t
    ...
    (y.prototype.textForXAxisLabel = function () {
      return this.getLabelText("x");
    }),
    (y.prototype.textForYAxisLabel = function () {
      return this.getLabelText("y");
    }),
    (y.prototype.textForY2AxisLabel = function () {
      return this.getLabelText("y2");
    }),
    (y.prototype.xForAxisLabel = function (t, e) {
      var i = this.owner;
      return t
        ? e.isLeft
          ? 0
    ...
    (y.prototype.dxForAxisLabel = function (t, e) {
      return t
        ? e.isLeft
          ? "0.5em"
          : e.isRight
    ...
    (y.prototype.textAnchorForAxisLabel = function (t, e) {
      return t
        ? e.isLeft
          ? "start"
          : e.isCenter
    ...
    (y.prototype.xForXAxisLabel = function () {
      return this.xForAxisLabel(
        !this.owner.config.axis_rotated,
        this.getXAxisLabelPosition()
      );
    }),
    (y.prototype.xForYAxisLabel = function () {
      return this.xForAxisLabel(
        this.owner.config.axis_rotated,
        this.getYAxisLabelPosition()
      );
    }),
    (y.prototype.xForY2AxisLabel = function () {
      return this.xForAxisLabel(
        this.owner.config.axis_rotated,
        this.getY2AxisLabelPosition()
      );
    }),
    (y.prototype.dxForXAxisLabel = function () {
      return this.dxForAxisLabel(
        !this.owner.config.axis_rotated,
        this.getXAxisLabelPosition()
      );
    }),
    (y.prototype.dxForYAxisLabel = function () {
      return this.dxForAxisLabel(
        this.owner.config.axis_rotated,
        this.getYAxisLabelPosition()
      );
    }),
    (y.prototype.dxForY2AxisLabel = function () {
      return this.dxForAxisLabel(
        this.owner.config.axis_rotated,
        this.getY2AxisLabelPosition()
      );
    }),
    (y.prototype.dyForXAxisLabel = function () {
      var t = this.owner,
        e = t.config,
    ...
    (y.prototype.dyForYAxisLabel = function () {
      var t = this.owner,
    ...
    (y.prototype.dyForY2AxisLabel = function () {
      var t = this.owner,
    ...
    (y.prototype.textAnchorForXAxisLabel = function () {
      var t = this.owner;
    ...
    (y.prototype.textAnchorForYAxisLabel = function () {
      var t = this.owner;
      return this.textAnchorForAxisLabel(
        t.config.axis_rotated,
        this.getYAxisLabelPosition()
    ...
    (y.prototype.textAnchorForY2AxisLabel = function () {
      var t = this.owner;
      return this.textAnchorForAxisLabel(
        t.config.axis_rotated,
        this.getY2AxisLabelPosition()
    ...
    (y.prototype.getMaxTickWidth = function (t, e) {
      var i,
        n,
        r,
        a,
    ...
    (y.prototype.updateLabels = function (t) {
      var e = this.owner,
    ...
    (y.prototype.getPadding = function (t, e, i, n) {
    ...
    (y.prototype.convertPixelsToAxisPadding = function (t, e) {
      var i = this.owner;
      return e * (t / (i.config.axis_rotated ? i.width : i.height));
    }),
    (y.prototype.generateTickValues = function (t, e, i) {
      var n,
        r,
        a,
        o,
    ...
    (y.prototype.generateTransitions = function (t) {
    ...
    (y.prototype.redraw = function (t, e) {
      var i = this.owner,
  ...
  var t = {
    ...
    chart: {
      ...
      internal: {
        fn: l.prototype,
        axis: { fn: y.prototype, internal: { fn: e.prototype } },
      },
    },
    generate: function (t) {
      return new r(t);
  ...
  (l.prototype.beforeInit = function () {}),
    ...
    (l.prototype.redraw = function (t, e) {
      var i,
        ...
        m = x.d3,
        S = x.config,
        w = x.getShapeIndices(x.isAreaType),
        v = x.getShapeIndices(x.isBarType),
        b = x.getShapeIndices(x.isLineType),
        T = x.hasArcType(),
        A = x.filterTargetsToShow(x.data.targets),
        P = x.xv.bind(x),
        C = B((t = t || {}), "withY", !0),
        L = B(t, "withSubchart", !0),
        V = B(t, "withTransition", !0),
        G = B(t, "withTransform", !1),
        E = B(t, "withUpdateXDomain", !1),
        O = B(t, "withUpdateOrgXDomain", !1),
        I = B(t, "withTrimXDomain", !0),
        R = B(t, "withUpdateXAxis", E),
        k = B(t, "withLegend", !1),
        F = B(t, "withEventRect", !0),
        D = B(t, "withDimension", !0),
        X = B(t, "withTransitionForExit", V),
        M = B(t, "withTransitionForAxis", V),
        z = V ? S.transition_duration : 0,
        H = X ? z : 0,
        N = M ? z : 0;
      if (
        ((e = e || x.axis.generateTransitions(N)),
        k && S.legend_show
          ? x.updateLegend(x.mapToIds(x.data.targets), t, e)
          : D && x.updateDimension(!0),
        x.isCategorized() &&
          0 === A.length &&
          x.x.domain([0, x.axes.x.selectAll(".tick").size()]),
        A.length
          ? (x.updateXDomain(A, E, O, I),
            S.axis_x_tick_values || (u = x.axis.updateXAxisTickValues(A)))
          : (x.xAxis.tickValues([]), x.subXAxis.tickValues([])),
        S.zoom_rescale && !t.flow && (p = x.x.orgDomain()),
        x.y.domain(x.getYDomain(A, "y", p)),
        x.y2.domain(x.getYDomain(A, "y2", p)),
        !S.axis_y_tick_values &&
          S.axis_y_tick_count &&
          x.yAxis.tickValues(
            x.axis.generateTickValues(x.y.domain(), S.axis_y_tick_count)
          ),
        !S.axis_y2_tick_values &&
          S.axis_y2_tick_count &&
          x.y2Axis.tickValues(
            x.axis.generateTickValues(x.y2.domain(), S.axis_y2_tick_count)
          ),
        x.axis.redraw(N, T),
      ...
      (i = x.generateDrawArea ? x.generateDrawArea(w, !1) : void 0),
        ...
        C &&
          (x.subY.domain(x.getYDomain(A, "y")),
          x.subY2.domain(x.getYDomain(A, "y2"))),
        x.updateXgridFocus(),
        y
          .select("text." + Y.text + "." + Y.empty)
          .attr("x", x.width / 2)
          .attr("y", x.height / 2)
          .text(S.data_empty_label_text)
          .transition()
          .style("opacity", A.length ? 0 : 1),
        F && x.redrawEventRect(),
        x.updateGrid(z),
        ...
        S.subchart_show &&
          x.redrawSubchart &&
          x.redrawSubchart(L, e, z, H, w, v, b),
        x.isStanfordGraphType() && x.drawColorScale(),
        y
          .selectAll("." + Y.selectedCircles)
          .filter(x.isBarType.bind(x))
          .selectAll("circle")
          .remove(),
        t.flow &&
          (d = x.generateFlow({
        ...
        z && x.isTabVisible()
          ? ((l = m.transition().duration(z)),
            (s = []),
            [
              x.redrawBar(n, !0, l),
              x.redrawLine(r, !0, l),
              x.redrawArea(i, !0, l),
              x.redrawCircle(f, _, !0, l),
              x.redrawText(a, o, t.flow, !0, l),
              x.redrawRegion(!0, l),
              x.redrawGrid(!0, l),
            ].forEach(function (t) {
            ...
            c(function () {
              d && d(), S.onrendered && S.onrendered.call(x);
            }))
          : (x.redrawBar(n),
            x.redrawLine(r),
            x.redrawArea(i),
            ...
            void 0 !== e.resizeTimeout && window.clearTimeout(e.resizeTimeout),
              (e.resizeTimeout = window.setTimeout(function () {
                delete e.resizeTimeout,
                  ...
                  e.brush && e.brush.update();
              }, 100));
          }),
        e.resizeFunction.add(function () {
          i.onresized.call(e);
        }),
        (e.resizeIfElementDisplayed = function () {
          null != e.api && e.api.element.offsetParent && e.resizeFunction();
        }),
        window.attachEvent
          ? window.attachEvent("onresize", e.resizeIfElementDisplayed)
          : window.addEventListener
          ? window.addEventListener("resize", e.resizeIfElementDisplayed, !1)
          : ((t = window.onresize)
              ? (t.add && t.remove) ||
                (t = e.generateResize()).add(window.onresize)
              : (t = e.generateResize()),
            t.add(e.resizeFunction),
            (window.onresize = function () {
              e.api.element.offsetParent && t();
            }));
    }),
    ...
    (l.prototype.parseDate = function (t) {
      ...
      return (
        t instanceof Date
          ...
          : ("object" !== s(t) && ("number" != typeof t || isNaN(t))) ||
            (e = new Date(+t)),
        (e && !isNaN(+e)) ||
    ...
    ((r.prototype.axis = function () {}).labels = function (e) {
      var i = this.internal;
      arguments.length &&
    ...
    (r.prototype.axis.max = function (t) {
      var e = this.internal,
        i = e.config;
      if (!arguments.length)
    ...
    (r.prototype.axis.min = function (t) {
      var e = this.internal,
        i = e.config;
      if (!arguments.length)
    ...
    (r.prototype.category = function (t, e) {
      var i = this.internal,
        n = i.config;
      return (
    ...
    (r.prototype.categories = function (t) {
      var e = this.internal,
        i = e.config;
      return (
    ...
    (r.prototype.data.values = function (t) {
      var e,
      ...
      (r = c.convertDataToTargets(e, !0)),
        c.data.targets.forEach(function (t) {
          for (var e, i = !1, n = 0; n < r.length; n++)
            if (t.id === r[n].id) {
              ...
              (t.values = t.values.concat(r[n].values)), r.splice(n, 1);
              break;
            }
          i || d.push(t.id);
        }),
        c.data.targets.forEach(function (t) {
          for (var e, i = 0; i < d.length; i++)
            if (t.id === d[i])
              for (
                h = t.values[t.values.length - 1].index + 1, e = 0;
                e < u;
                e++
              )
                t.values.push({
    ...
    (r.prototype.defocus = function (e) {
      var t = this.internal;
    ...
    (r.prototype.xgrids.remove = function (t) {
      this.internal.removeGridLines(t, !0);
    }),
    ((r.prototype.ygrids = function (t) {
      var e = this.internal,
        i = e.config;
      return (
    ...
    (r.prototype.ygrids.remove = function (t) {
      this.internal.removeGridLines(t, !1);
    }),
    (r.prototype.groups = function (t) {
      var e = this.internal,
        i = e.config;
      return w(t) || ((i.data_groups = t), e.redraw()), i.data_groups;
    }),
    ((r.prototype.legend = function () {}).show = function (t) {
      var e = this.internal;
      e.showLegend(e.mapToTargetIds(t)), e.updateAndRedraw({ withLegend: !0 });
    }),
    (r.prototype.legend.hide = function (t) {
      var e = this.internal;
    ...
    (r.prototype.load = function (e) {
      var t = this.internal,
        i = t.config;
      e.xs && t.addXs(e.xs),
        "names" in e && r.prototype.data.names.bind(this)(e.names),
        "classes" in e &&
    ...
    (r.prototype.regions.remove = function (t) {
      var e = this.internal,
        i = e.config,
        n = B((t = t || {}), "duration", i.transition_duration),
        r = B(t, "classes", [Y.region]),
        a = e.main.select("." + Y.regions).selectAll(
          r.map(function (t) {
            return "." + t;
          })
        );
      return (
        (n ? a.transition().duration(n) : a).style("opacity", 0).remove(),
    ...
    (r.prototype.select = function (c, d, l) {
      var u = this.internal,
        h = u.d3,
        g = u.config;
    ...
    (r.prototype.unselect = function (c, d) {
      var l = this.internal,
        u = l.d3,
        h = l.config;
    ...
    (r.prototype.show = function (t, e) {
      ...
      (t = n.mapToTargetIds(t)),
        ...
        (i = n.svg.selectAll(n.selectorTargets(t)))
          .transition()
          .style("display", p() ? "block" : "initial", "important")
    ...
    ((r.prototype.subchart = function () {}).isShown = function () {
      return this.internal.config.subchart_show;
    }),
    (r.prototype.subchart.show = function () {
      var e = this.internal;
    ...
    (r.prototype.subchart.hide = function () {
      var t = this.internal;
      t.config.subchart_show &&
        ((t.config.subchart_show = !1), t.removeSubchart(), t.redraw());
    }),
    ((r.prototype.tooltip = function () {}).show = function (e) {
      var t,
        i,
        n = this.internal,
        r = {},
      ...
      n.dispatchEvent("mousemove", r), n.config.tooltip_onshow.call(n, i);
    }),
    (r.prototype.tooltip.hide = function () {
    ...
    (r.prototype.zoom.max = function (t) {
      var e = this.internal,
        i = e.config,
        n = e.d3;
    ...
    (r.prototype.zoom.min = function (t) {
      var e = this.internal,
        i = e.config,
        n = e.d3;
    ...
    (r.prototype.zoom.range = function (t) {
      if (!arguments.length)
    ...
    (l.prototype.initPie = function () {
      ...
      var i,
        n = t.getOrderFunction();
      n &&
        (t.isOrderAsc() || t.isOrderDesc()) &&
        ((i = n),
        (n = function (t, e) {
          return -1 * i(t, e);
        })),
      ...
      return (
        d && !u
              ...
              a *
                (n =
                  s.hasType("donut") && c.donut_label_ratio
                    ? g(c.donut_label_ratio)
                      ? c.donut_label_ratio(t, s.radius, i)
                      : c.donut_label_ratio
                    : s.hasType("pie") && c.pie_label_ratio
                    ? g(c.pie_label_ratio)
                      ? c.pie_label_ratio(t, s.radius, i)
                      : c.pie_label_ratio
                    : s.radius && i
                    ? ((0.375 < 36 / s.radius ? 1.175 - 36 / s.radius : 0.8) *
                        s.radius) /
                      i
                    : 0) +
              "," +
          ...
          : d &&
            ...
            ((r = Math.sin(d.endAngle - Math.PI / 2)),
            (l =
              "translate(" +
              (a =
                Math.cos(d.endAngle - Math.PI / 2) * (s.radiusExpanded + 25)) +
              "," +
              (o = r * (s.radiusExpanded + 15 - Math.abs(10 * r)) + 3) +
              ")")),
        l
      );
    }),
    ...
    (l.prototype.updateTargetsForArc = function (t) {
      ...
      o.append("g").attr("class", r),
        o
          .append("text")
          .attr("dy", e.hasType("gauge") ? "-.1em" : ".35em")
          .style("opacity", 0)
    ...
    (l.prototype.redrawArc = function (t, e, i) {
      ...
      d &&
        ((r = (n = c
          ...
          .attr("class", function (t) {
            return (
              Y.arcLabelLine + " " + Y.target + " " + Y.target + "-" + t.data.id
            );
          })
          .merge(n)),
              ...
              .each(function (t) {
                ...
                l.hiddenTargetIds.indexOf(t.data.id) < 0 &&
                  ...
                  (i =
                    ...
                    (e.index + 1)),
                  (a =
                    (n = e.endAngle - Math.PI / 2) -
                    (0 == (r = l.radius - i) ? 0 : 1 / r)),
                  ...
                  u
                    ...
                    .attr("height", 2)
                    .attr("transform", d)
                    .style("stroke-dasharray", "0, " + (o + 2) + ", 0");
              })),
        g
    ...
    (l.prototype.getClipPath = function (t) {
      return "url(" + (p(9) ? "" : document.URL.split("#")[0]) + "#" + t + ")";
    }),
    ...
    (l.prototype.convertUrlToData = function (t, e, i, n, r) {
      var a,
        ...
        c =
          "json" === s
            ? ((a = o.d3.json), o.convertJsonToData)
            : ((a = "tsv" === s ? o.d3.tsv : o.d3.csv), o.convertXsvToData);
      a(t, i)
        .then(function (t) {
          ...
          return {
            ...
            values: t
              .map(function (t, e) {
                ...
                return (
                  l.isCustomX() && l.isCategorized() && !w(r)
    ...
    (l.prototype.checkValueInTargets = function (t, e) {
      for (var i, n, r = Object.keys(t), a = 0; a < r.length; a++)
        for (n = t[r[a]].values, i = 0; i < n.length; i++)
    ...
    (l.prototype.getRatio = function (t, e) {
      ...
      return (
        e &&
          o.data.shown.call(o).length &&
          ((s = e.ratio || e.value),
          "arc" === t
            ? (s = a.hasType("gauge")
                ? (e.endAngle - e.startAngle) /
                  (Math.PI * (a.config.gauge_fullCircle ? 2 : 1))
                : ((i = a.getTotalDataSum()), e.value / i))
            : "index" === t &&
              ((n = a.getTotalPerIndex(a.axis.getId(e.id))),
              (e.ratio =
                d(e.value) && n && 0 < n[e.index] ? e.value / n[e.index] : 0),
              (s = e.ratio))),
        r && s ? 100 * s : s
      );
    }),
    ...
    (l.prototype.getYDomain = function (t, e, i) {
      ...
      var a,
        ...
        x = i ? n.filterByXDomain(_, i) : _,
        y = "y2" === e ? r.axis_y2_min : r.axis_y_min,
        m = "y2" === e ? r.axis_y2_max : r.axis_y_max,
        S = n.getYDomainMin(x),
        w = n.getYDomainMax(x),
        v = "y2" === e ? r.axis_y2_center : r.axis_y_center,
        b =
          (n.hasType("bar", x) && r.bar_zerobased) ||
          (n.hasType("area", x) && r.area_zerobased),
        T = "y2" === e ? r.axis_y2_inverted : r.axis_y_inverted,
        A = n.hasDataLabel() && r.axis_rotated,
        P = n.hasDataLabel() && !r.axis_rotated,
        S = C(y) ? y : !C(m) || S < m ? S : m - 10,
        w = C(m) ? m : !C(y) || y < w ? w : y + 10;
      return 0 === x.length
        ? "y2" === e
          ? n.y2.domain()
          : n.y.domain()
        : (isNaN(S) && (S = 0),
          ...
          ((C(y) && g) || (C(m) && p)) && (b = !1),
          b && (g && (S = 0), p && (w = 0)),
          (s = c = 0.1 * (o = Math.abs(w - S))),
          void 0 !== v &&
            ((w = v + (d = Math.max(Math.abs(S), Math.abs(w)))), (S = v - d)),
          A
            ? ((l = n.getDataLabelLength(S, w, "width")),
              (u = R(n.y.range())),
              (s += o * ((h = [l[0] / u, l[1] / u])[1] / (1 - h[0] - h[1]))),
              (c += o * (h[0] / (1 - h[0] - h[1]))))
            : P &&
              ((l = n.getDataLabelLength(S, w, "height")),
              (s += (f = n.getY(
    ...
    (l.prototype.getXDomainPadding = function (t) {
      var e,
        ...
        o = this.isCategorized()
          ...
          : 0.01 * a;
      return (
        "object" === s(r.axis_x_padding) && L(r.axis_x_padding)
          ? ((i = C(r.axis_x_padding.left) ? r.axis_x_padding.left : o),
            (n = C(r.axis_x_padding.right) ? r.axis_x_padding.right : o))
          : (i = n =
              "number" == typeof r.axis_x_padding ? r.axis_x_padding : o),
        { left: i, right: n }
      );
    }),
    ...
    (l.prototype.drag = function (t) {
      var e,
        ...
        y = _.d3;
      _.hasArcType() ||
        (x.data_selection_enabled &&
          x.data_selection_multiple &&
          ((e = _.dragStart[0]),
          (i = _.dragStart[1]),
          (n = t[0]),
          (r = t[1]),
                  ...
                  if (!s.dragging) {
                    ...
                    if (!s.hasArcType(t)) {
                      var e,
                        ...
                        n,
                        r = c.mouse(this),
                        a = h(s.findClosestFromTargets(t, r)),
                        o = u(r, a);
                      if (
                        (!s.mouseover ||
                          (a &&
                            a.id === s.mouseover.id &&
                            a.index === s.mouseover.index) ||
                          (d.data_onmouseout.call(s.api, s.mouseover),
                          (s.mouseover = void 0)),
                        a &&
                          !s.mouseover &&
                          (d.data_onmouseover.call(s.api, a),
                          (s.mouseover = a)),
                        s.svg
                          .select("." + Y.eventRect)
                          .style("cursor", o ? "pointer" : null),
                        !d.tooltip_grouped || s.hasType("stanford", t)
                          ? a && (e = [a])
                          : (n =
                              a ||
                              ((i = d.axis_rotated ? r[1] : r[0]),
                              s.findClosestFromTargetsByX(t, s.x.invert(i)))) &&
                            (e = s.filterByX(t, n.x)),
                        !e || 0 === e.length)
                      )
                        return l();
            ...
            d.interaction_enabled
              ? function () {
                  var t,
                    e,
                    i,
                    n = s.getTargetsToShow();
                  s.hasArcType(n) ||
                    ((t = c.mouse(this)),
                    (e = h(s.findClosestFromTargets(n, t))),
                    u(t, e) &&
                      ((!d.data_selection_grouped || s.isStanfordType(e)
                        ? [e]
                        : s.filterByX(n, e.x)
                      ).forEach(function (t) {
                        s.main
                      ...
                      e &&
                        ((i = s.main
                          .selectAll(
                            "." + Y.shapes + s.getTargetSelectorSuffix(e.id)
                          )
                          .select("." + Y.shape + "-" + e.index)),
        ...
        a =
          "y" === t.axis || "y2" === t.axis
            ? i.axis_rotated && "end" in t
              ...
              : e.width
            : !i.axis_rotated && "end" in t
            ? e.x(e.isTimeSeries() ? e.parseDate(t.end) : t.end)
            : e.width;
      return a < n ? 0 : a - n;
    }),
          ...
          var e = d.line_connectNull ? c.filterRemoveNull(t.values) : t.values,
            ...
            o = c.isLineType(t)
              ? d.data_regions[t.id]
                ...
                : (c.isStepType(t) && (e = c.convertValuesToStep(e)),
                  l.curve(c.getInterpolate(t))(e))
    ...
    (l.prototype.getCurrentPaddingLeft = function (t) {
      ...
      return C(e.padding_left)
        ...
        ? !e.axis_x_show || e.axis_x_inner
          ? 1
          : Math.max(c(this.getAxisWidthByAxisId("x", t)), 40)
        : !e.axis_y_show || e.axis_y_inner
        ? this.axis.getYAxisLabelPosition().isOuter
          ? 30
          : 1
        : c(this.getAxisWidthByAxisId("y", t));
    }),
    ...
    (l.prototype.updateTargetsForSubchart = function (t) {
      var e,
        ...
        r = n.context,
        a = n.config,
        o = n.classChartBar.bind(n),
        s = n.classBars.bind(n),
        c = n.classChartLine.bind(n),
        d = n.classLines.bind(n),
        l = n.classAreas.bind(n),
        u = r
          .select("." + Y.chartBars)
          .selectAll("." + Y.chartBar)
          .data(t),
        h = u.enter().append("g").style("opacity", 0);
      h.merge(u).attr("class", o),
        ...
        r
          ...
          .attr(
            ...
            a.axis_rotated ? n.width2 : n.height2
          );
    }),
    ...
    (l.prototype.getXForText = function (t, e, i) {
      var n,
        ...
        o = r.config.axis_rotated
          ? ((n = r.isBarType(e) ? 4 : 6), t[2][1] + n * (e.value < 0 ? -1 : 1))
          : r.hasType("bar")
          ? (t[2][0] + t[0][0]) / 2
          : t[0][0];
      return (
        null === e.value &&
          (o > r.width ? (o = r.width - a.width) : o < 0 && (o = 4)),
        o
      );
    }),
    ...
    (l.prototype.drawColorScale = function () {
      var t,
        ...
        c = o.config,
        d = o.data.targets[0],
        l = isNaN(c.stanford_scaleWidth) ? 20 : c.stanford_scaleWidth;
      if (l < 0)
        throw Error(
      ...
      (a = o.height - c.stanford_padding.bottom - c.stanford_padding.top),
        ...
        o.colorScale
          ...
          .attr(
            "transform",
            "translate(0, ".concat(c.stanford_padding.top, ")")
          )
          .selectAll("bars")
          .data(e)
          .enter()
        ...
        (n = s
          .scaleLog()
          .domain([d.minEpochs, d.maxEpochs])
          .range([
            e[0] + c.stanford_padding.top + e[e.length - 1] + 5 - 1,
            e[0] + c.stanford_padding.top,
          ])),
        (i = s.axisRight(n)),
        "pow10" === c.stanford_scaleFormat
          ? i.tickValues([1, 10, 100, 1e3, 1e4, 1e5, 1e6, 1e7])
          : g(c.stanford_scaleFormat)
          ? i.tickFormat(c.stanford_scaleFormat)
          : i.tickFormat(s.format("d")),
        g(c.stanford_scaleValues) &&
          i.tickValues(c.stanford_scaleValues(d.minEpochs, d.maxEpochs)),
        (t = o.colorScale
          .append("g")
        ...
        o.colorScale.attr(
          "transform",
          "translate(".concat(o.currentWidth - o.xForColorScale(), ", 0)")
        );
    }),
    (l.prototype.xForColorScale = function () {
      return (
        this.config.stanford_padding.right + f(this.colorScale.node()).width
      );
    }),
    ...
    (l.prototype.getCentroid = function (t) {
      for (
        var e, i, n, r = b(t), a = 0, o = 0, s = 0, c = t.length - 1;
        s < t.length;
        c = s, s += 1
      )
        (i = t[s]),
    ...
    (l.prototype.countEpochsInRegion = function (i) {
      var t = this.data.targets[0],
        ...
        n = t.values.reduce(function (t, e) {
          return T(e, i) ? t + Number(e.epochs) : t;
        }, 0);
      return { value: n, percentage: 0 !== n ? ((n / e) * 100).toFixed(1) : 0 };
    });
  var b = function (t) {
      for (
        var e, i, n = 0, r = 0, a = t.length - 1;
        r < t.length;
        a = r, r += 1
      )
        (e = t[r]), (i = t[a]), (n += e.x * i.y), (n -= e.y * i.x);
      return (n /= 2);
    },
    T = function (t, e) {
      for (
  ...
  return (
    ...
    (l.prototype.updateStanfordElements = function (t) {
      ...
      h
        ...
        (i = (e = o
          ...
          .attr("points", function (t) {
            return t.points
              .map(function (t) {
                return [
                  s.axis_rotated ? d(t, "y") : c(t, "x"),
                  s.axis_rotated ? c(t, "x") : d(t, "y"),
                ].join(",");
              })
              .join(" ");
          })
        ...
        a.stanfordRegions
          ...
          .duration(t)
          .attr("x", function (t) {
            return s.axis_rotated
              ? d(a.getCentroid(t.points), "y")
              : c(a.getCentroid(t.points), "x");
          })
          .attr("y", function (t) {
            return s.axis_rotated
              ? c(a.getCentroid(t.points), "x")
          ...
          .text(function (t) {
            var e, i, n;
            return t.text
              ? (a.isStanfordGraphType() &&
                  ((e = (n = l(t.points)).value), (i = n.percentage)),
                t.text(e, i))
              : "";
          })
          .attr("text-anchor", "middle")
    ...
    (l.prototype.initTooltip = function () {
      ...
      if (
        ...
        if (e.isTimeSeries() && x(i.tooltip_init_x)) {
          for (
    ...
    (l.prototype.getTooltipSortFunction = function () {
      ...
      if (x(n) && "asc" === n.toLowerCase())
        return function (t, e) {
          return r(t) - r(e);
        };
      if (x(n) && "desc" === n.toLowerCase())
        return function (t, e) {
          return r(e) - r(t);
        };
      if (g(n)) {
      ...
      return (
        (i.zoom = n
          ...
          .on("start", function () {
            var t;
            "scroll" === r.zoom_type &&
              (((t = n.event.sourceEvent) && "brush" === t.type) ||
      ...
      "drag" === r.zoom_type &&
        ...
        (t = i.dragZoomBrush =
          n
            ...
            .on("end", function () {
              var t;
              null != n.event.selection &&
                ((t = e(n.event.selection)),
        ...
        a
          ...
          .attr("clip-path", i.clipPath)
          .attr("transform", "translate(" + o + "," + s + ")")
          .call(t));
    }),
